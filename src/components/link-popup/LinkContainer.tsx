...
const LinkContainer: React.FC = () => {
  ...
  const onSubmitSample = async (event) => {
    ...
    .then((response) => {
      console.log(response)
      setData({link : 'postgres://ordddiou:g5OjOyAIFxf-tsLk1uwu4ZOfbJfiCFbh@ruby.db.elephantsql.com:5432/ordddiou', modal: false, schema: response.schema, d3Data: response.d3Data})
    })
  }
