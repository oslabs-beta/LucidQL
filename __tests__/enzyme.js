...
describe('React Unit Test', () => {
  ...
  // describe('Download Button Test', () => {
  //   let wrapper;
  //   const props = {
  //     handleDownloadFiles: jest.fn(),
  //   };
  //   beforeAll(() => {
  //     wrapper = mount(
  //       <RecoilRoot>
  ...
  //     );
  //   });
  //   it('Button will download files once it has been clicked on', () => {
  //     wrapper.find('#downloadButton2').simulate('click');
  //     expect(props4.handleDownLoadFiles).toHaveBeenCalled();
  //   });
  // });

  // describe('Modal should be open', () => {
  //   let app;
  //   beforeAll(() => {
  //     app = shallow(<state />);
  //   });
  //   it('Modal should be true', () => {
  //     expect(app.state('key')).toEqual('state');
  //   });
  // });
});
